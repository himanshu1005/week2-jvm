    ...
    public void run() {
        ...
        while(true) {
            ...
            while(! tryLockBothLocks()) {
                failureCount++;
                int multiplier = rand.nextInt(20);
            ...
            //unlock
            System.out.println(threadName + " runnable 1 , unlocking 2");
            this.lockGraphFacade.unlock(this.lock2);
            System.out.println(threadName + " runnable 1 , unlocking 1");
            this.lockGraphFacade.unlock(this.lock1);

            sleep(500L * rand.nextInt(10));
        }
    }
